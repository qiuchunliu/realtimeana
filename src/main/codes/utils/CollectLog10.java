...
public class CollectLog10 {
   public static void main(String[] args){
       ...
       prop.put("bootstrap.servers", "t21:9092,t22:9092,t23:9092");
       ...
       try {
           BufferedReader bf = new BufferedReader(
                   new FileReader(
                           new File(
                                   "D:\\BIGDATA_FILES\\1_notes\\7-16-pro" +
                                           "ject_of_spark_08_realtime\\cmcc.json")));// 路径
           String line = null;
           while((line=bf.readLine())!=null){
               Thread.sleep(1000);  // 设置多少秒产生一条数据
               producer.send(
